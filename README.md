...
```bash
pip install climb_jupyterlab_extension
```
...
```bash
pip uninstall climb_jupyterlab_extension
```
...
# Change directory to the climb_jupyterlab_extension directory
...
folder is located. Then you can remove the symlink named `climb-jupyterlab-extension` within that folder.
